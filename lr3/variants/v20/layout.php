<?php
/**
 * Shared layout template for LR3 Variant 20 task pages
 */
...
function renderVariantLayout(string $content, string $taskName, string $bodyClass = ''): void
{
    ...
    $demoUrl = "/lr3/demo/{$currentTask}?from=v20";
    ?>
<!DOCTYPE html>
<html lang="uk">
...
<head>
    <meta charset="UTF-8">
    <title><?= htmlspecialchars($taskName) ?> — Варіант 20 ЛР3</title>
...
<body class="body-with-header <?= htmlspecialchars($bodyClass) ?>">
    <header class="header-fixed">
        <div class="header-left">
            ...
            <a href="index.php" class="header-btn">← Варіант 20</a>
            <a href="<?= htmlspecialchars($demoUrl) ?>" class="header-btn header-btn-demo">Demo</a>
        </div>
        <div class="header-center"></div>
        <div class="header-right">
            <span class="header-variant-label">В-20</span>
