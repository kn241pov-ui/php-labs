 ...
 *
 * Варіант 20: метод об'єкта Product, що виводить значення властивостей
 */
...
{
    <span class="code-keyword">return</span> <span class="code-string">"Планета: {$this->name}, Діаметр: {$this->diameter} км, Супутників: {$this->moons}"</span>;
}
...
<div class="section-divider">
    <span class="section-divider-text">Картки Планет</span>
</div>
    ...
    <div class="user-card">
        ...
        <div class="user-card-body">
            ...
            <div class="user-card-field">
                ...
                <span class="user-card-field-value"><?= $product->diameter ?> км</span>
            </div>
            <div class="user-card-field">
                <span class="user-card-field-label">moons</span>
                <span class="user-card-field-value"><?= $product->moons ?></span>
            </div>
        </div>
    </div>
    <?php endforeach; ?>
