 ...
 *
 * Варіант 20 (група C, Sub3): дні + день тижня (українською)
 * Дати: 28-12-2023 та 20-10-2025 → 662 днів, четвер — понеділок
 */
...
$date1 = $_POST['date1'] ?? '28-12-2023';
$date2 = $_POST['date2'] ?? '20-10-2025';
