...
$navItems = [
    'index/main' => 'Головна',
    'order/list' => 'Замовлення',
    'guestbook/index' => 'Відгуки',
...
<head>
    ...
    <title><?= htmlspecialchars($pageTitle ?? 'Сервіс Пральні') ?> — v20</title>
    ...
    <header class="header">
        <div class="container">
            <div class="header__inner">
                <a href="index.php" class="header__logo">Чиста Пральня</a>
